...
const commentValidationSchemas = require('./components/comments/commentValidationSchemas');
const commentRoutes = require('./components/comments/commentRoutes');

const postValidationSchemas = require('./components/posts/postValidationSchemas');
const postRoutes = require('./components/posts/postRoutes');

const userValidationSchemas = require('./components/users/userValidationSchemas');
